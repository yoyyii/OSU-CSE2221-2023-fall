...
public final class MonteCarlo {
    ...
    public static void main(String[] args) {
        ...
        while (ptsInInterval < n) {
            /*
             * Generate pseudo-random number in x direction [0.0,2.0) interval
             */
            double x = rnd.nextDouble() * 2;

            /*
             * Generate pseudo-random number in y direction [0.0,2.0) interval
             */
            ...
            //calculate the distance from center to point to
         ...
         * fall in the [1.0,1.0) subinterval
         */
